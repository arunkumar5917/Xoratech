...
export function HelpFaqModal() {
  ...
  return (
    <>
      ...
      {/* FULL MODAL OVERLAY & SLIDE-DOWN DRAWER VIA PORTAL */}
      {mounted &&
        createPortal(
          <AnimatePresence>
            {isOpen && (
              <div className="fixed inset-0 z-[999999] flex flex-col items-center justify-start overflow-y-auto px-3 pt-20 pb-6 sm:px-6 sm:pt-24">
                {/* Dark Backdrop */}
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  ...
                  className="fixed inset-0 bg-navy-950/75 backdrop-blur-md"
                />
                ...
                <motion.div
                  ...
                  className="relative z-20 flex flex-col w-full max-w-3xl max-h-[85vh] overflow-hidden rounded-3xl border border-navy-100 bg-white shadow-[0_25px_60px_-15px_rgba(0,0,0,0.4)] dark:border-navy-800 dark:bg-navy-950"
                >
                  {/* Header */}
                  <div className="relative border-b border-navy-100 bg-gradient-to-r from-navy-50/80 via-white to-xora-50/40 p-5 sm:p-6 dark:border-navy-800 dark:from-navy-900 dark:via-navy-950 dark:to-xora-950/20">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-xl border border-navy-200/90 bg-white px-3.5 py-2 text-xs font-bold text-navy-700 shadow-sm transition-all hover:border-rose-400 hover:bg-rose-50 hover:text-rose-600 hover:shadow-md active:scale-95 dark:border-navy-700 dark:bg-navy-900 dark:text-navy-200 dark:hover:border-rose-800 dark:hover:bg-rose-950/50 dark:hover:text-rose-300"
                      >
