      ...
      <section className="bg-transparent py-20 lg:py-28">
        <div className="container-x">
          <div className="mx-auto max-w-xl text-center">
            <div className="rounded-3xl border border-navy-100 dark:border-navy-800 bg-white/80 dark:bg-navy-900/80 backdrop-blur-md p-8 sm:p-12 shadow-card">
              <h2 className="font-display text-2xl font-bold text-navy-950 dark:text-white">
